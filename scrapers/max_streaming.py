...
class MaxScraper(BaseScraper):
    service_id = "max"
    service_name = "Max"
    pricing_url = "https://www.max.com/ar/es/plans"
    ...
    async def _try_plan_cards(self, page: Page) -> List[ScrapedPlan]:
        selectors = [
            ("[data-testid='plan-card']", "[data-testid='plan-name']", "[data-testid='plan-price']"),
            (".planCard", ".planName", ".planPrice"),
            (".PlanCard", ".PlanCard__title", ".PlanCard__price"),
        ]
